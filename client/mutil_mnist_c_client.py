...
print("--- Different ways to access different models ---")
model = PredictModelRESTAPI(model_name='model_1', input_name='flatten_input', output_name='dense_1', socket='localhost:8501')
res = model.inference(img)

model = PredictModelRESTAPI(model_name='model_2', input_name='flatten_input', output_name='dense_1', socket='localhost:8501')
res = model.inference(img)


model = PredictModelGrpc(model_name='model_1', input_name='flatten_input', output_name='dense_1', socket='0.0.0.0:8500')
res = model.inference(img)

model = PredictModelGrpc(model_name='model_2', input_name='flatten_input', output_name='dense_1', socket='0.0.0.0:8500')
res = model.inference(img)
